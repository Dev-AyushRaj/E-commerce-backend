    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menmbership', models.CharField(choices=[('B', 'BRONZE'), ('S', 'SILVER'), ('G', 'GOLD')], default='B', max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='Cart',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payement_staus', models.CharField(choices=[('P', 'Pending'), ('C', 'Completed'), ('F', 'Failed')], default='P', max_length=1)),
